...
The code to implement these marginal distributions is shown below. Helper 
functions to ease the workflow will be implemented in future versions of the 
package.
...
Now we can use the `simdata::simdesign_norta` to obtain a design using these
