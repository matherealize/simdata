...
#' `check_and_infer` is TRUE.
#' @param types_final
#' Optional vector of length equal to `n_var_final` (set by the user or 
...
#' If not specified by, inferred if `check_and_infer` is set to TRUE.
#' @param name
